...
async function getCurrentCampaign() {
  ...
  /**
   * @type {import("../../spinx-app/web/models/campaign/Campaign").Campaign}
   */
  const campaign = {
    id: '1',
    ...
    config: {
      ...
      popup: {
        ...
        title: {
          customized: false,
          text: 'Win an exclusive prize!',
          // size: 32,
          color: '#ffffff',
        },
        content: {
          customized: false,
          text: 'Enter your information to spin the wheel for a chance to win.',
          // size: 20,
          color: '#ffffff',
        },
        contentForExistingAccount: {
          customized: false,
          text: 'Welcome to the lucky spin program, {{NAME}}. Chance to win attractive prizes!',
          // size: 20,
          color: '#ffffff',
        },
      ...
      announcement: {
        ...
        upcomingEvent: {
          enabled: true,
          content: 'The lucky wheel program with attractive prizes will launch at {{TIME}}',
          displayDays: 7
        },
        readyToSpin: {
          enabled: true,
          content: 'Click {{SPIN}} to receive attractive prizes now!'
        },
        countDownToLaunch: {
          enabled: true,
          content: 'The countdown begins! Just {{TIME}} until the event starts!',
          displayHours: 72
        },
        countDownToClose: {
          enabled: true,
          content: 'Event will end in {{TIME}}! Click {{SPIN}} to get attractive prizes now.',
          displayHours: 24
        },
        // attentionEffect: {
        //   enabled: true,
      ...
      langs: {
        vi: {
          ...
          prizes: [
            ...
            },
            {
              id: '2',
              name: "Giảm giá 10%",
              messageTitle: 'Bạn đã thắng "{{PRIZE}}"!',
        ...
        en: {
          popup: {
            title: "Get attractive prizes!",
            content: "Enter your details to spin the wheel and get a chance to win.",
            contentForExistingAccount: "Welcome to the lucky spin program, {{NAME}}. Chance to win attractive prizes!",
            agreement: "I agree that my personal data is stored and used to receive newsletters.",
            spinButton: "Spin!",
            fields: [{
              name: 'name',
              label: 'Name',
          ...
          announcement: {
            upcomingEvent: {
              content: 'Lucky draw program with attractive prizes will be launched at {{TIME}}'
            },
            readyToSpin: {
              content: 'Click {{SPIN}} to get attractive prizes now!'
            },
            // readyToSpinAgain: {
            //   content: 'Bạn vừa nhận được một lượt quay mới! Nhấp vào {{SPIN}} để nhận ngay những giải thưởng hấp dẫn!'
            // },
          ...
          prizes: [
            ...
            },
            {
              id: '2',
              name: "10% off",
              messageTitle: 'You Won {{PRIZE}}!',
              messageContent: "Copy your coupon code and use it into the discount input at checkout page."
            },
            {
              id: '3',
              name: "Free shipping",
...
function setSpinXParams() {
  ...
  else if (window.SpinX.version === 'WIDGET' + '_VERSION') {
    window.SpinX.isDevelopment = true;
    window.SpinX.version = '';
    window.SpinX.spinxSharePath = '/src';
  }
  window.SpinX.campaign.store.config.logo.url = window.SpinX.spinxSharePath + '/assets/images/logo/spinx_512x512.png'
